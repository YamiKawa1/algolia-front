                  ...
                  <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="relative w-full px-4 max-w-full flex-grow flex-1 py-7">
                        ...
                        <button className=" rounded-md border border-transparent text-base font-medium text-white shadow-sm absolute end-1 bottom-2 bg-indigo-600 hover:bg-indigo-700 text-sm px-4 py-2 mr-24" type="button">Crear producto</button>
                      </div>
                    </div>
                  </div>
