      ...
      <div className="space-y-12 px-10 mx-10 pt-10">
        <div className="border-b border-gray-900/10 pb-12">
          <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <select id="countries" className="bg-gray-50 rounded-md border border-gray-200 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-2">
              <option selected>Elija un tipo de pago</option>
              <option value="US">En casa</option>
              <option value="CA">Pago movil Banco de Venezuela</option>
              <option value="FR">Transferencia Banco de Venezuela</option>
            </select>
